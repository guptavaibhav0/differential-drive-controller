...
%% Path Tracking
epsFile = 'Figs\path-tracking-offset.eps';
tiffFile = 'Figs\path-tracking-offset.tiff';
...
epsFile = 'Figs\velocity-tracking-offset.eps';
tiffFile = 'Figs\velocity-tracking-offset.tiff';
xLabel = 'Time (in sec)';
...
%% Positional Error
epsFile = 'Figs\positional-error-offset.eps';
tiffFile = 'Figs\positional-error-offset.tiff';
xLabel = 'Time (in sec)';
...
%% Required Torque
epsFile = 'Figs\required-torque-offset.eps';
tiffFile = 'Figs\required-torque-offset.tiff';
xLabel = 'Time (in sec)';
